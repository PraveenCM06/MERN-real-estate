...
function Search() {
  ...
  const onShowMoreClick = async ()=>{
    ...
    const searchQuery = urlParams.toString();
    const results= await fetch(`/api/listing/get?${searchQuery}`);
    ...
    <div className="flex flex-col md:flex-row p-2 gap-4 ">
      ...
      <div className="flex-1">
        ...
        <div className="p-7 flex flex-wrap gap-4 justify-center">
            ...
            {showMore && (
                <button className="text-green-700 hover:underline p-7 w-full text-center" onClick={onShowMoreClick}>Show More..</button>
            )}
        </div>
